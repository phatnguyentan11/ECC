...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 29 agents, 96 skills, and 50 legacy command shims.
...
**That's it!** You now have access to 29 agents, 96 skills, and 50 legacy command shims.
...
| Skills | PASS: 96 skills | PASS: 37 skills | **Claude Code leads** |
...
| **Skills** | 96 | Shared | 10 (native format) | 37 | Via instructions |
